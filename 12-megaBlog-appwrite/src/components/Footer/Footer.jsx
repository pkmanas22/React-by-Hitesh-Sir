        ...
        <footer className="w-[100vw] bg-white container border-t-2 mx-auto p-6 lg:py-8">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    ...
                    <p className='text-center text-slate-500'>A hub for writers & readers</p>
                </div>
                <div className="grid grid-cols-3 gap-8 sm:gap-6">
                    <div>
                        ...
                        <ul className="text-gray-500  font-medium  space-y-1">
                            <li>
                                <a target="_blank" href="#" className="hover:underline">Source Code</a>
                            </li>
                            <li>
                                <a target="_blank" href="#" className="hover:underline">Post Pallete</a>
                            </li>
                            <li>
                                <a target="_blank" href="#" className="hover:underline">Tailwind CSS</a>
                            </li>
                            <li>
                                <a target="_blank" href="#" className="hover:underline">Acertinity UI</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center">&copy; 2024 <a target="_blank" href="/" className="hover:underline">PostPallete™</a>. All Rights Reserved
                </span>
